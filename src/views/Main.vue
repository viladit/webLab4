      ...
      <div class="row">
            ...
            <div class="svg-wrapper">
              <svg height="300" width="300" xmlns="http://www.w3.org/2000/svg" id="graph" @click="validateFromGraph">
                ...
                <polygon id="rectangle"
                         ...
                         fill-opacity="0.2"
                         stroke="blue"
                         points="150,100 150,150 250,150 250,100"></polygon>
                ...
                <polygon id="triangle"
                         ...
                         fill-opacity="0.2"
                         stroke="blue"
                         points="150,50 50,150 150,150"></polygon>
                ...
                <path id="circle"
                      ...
                      fill-opacity="0.2"
                      stroke="blue"
                      d="M 150 200 A 45 45, 90, 0, 0, 200 150 L 150 150 Z"></path>
        ...
        <div class="text-center">
          ...
          <div class="inputs">
            ...
            <div class="row">
              <label class="text-label">
                <input id="input-y" class="text-input" type="text" name="y" placeholder="[-5; 3]" maxlength="14" v-model="y"/>
              </label>
            </div>
          </div>
  ...
  watch: {
    ...
    r(val){
      if(this.validateInput(-5, 3, 'input-r', val)) {
        ...
        circle.setAttribute("d", `M 150 ${150 + 16.7 * r} A ${r * 16.7} ${r * 16.7}, 90, 0, 0, ${150 + 16.7 * r} 150 L 150 150 Z`);
        rectangle.setAttribute("points", `150,${150 - 16.7 * r} 150,150 ${150 + 33.4 * r},150 ${150 + 33.4 * r},${150 - 16.7 * r}`);
        triangle.setAttribute("points", `${150 - 33.4 * r},150 150,${150 - 33.4 * r} 150,150 `);
        this.drawDots();
      }
    }
  },
